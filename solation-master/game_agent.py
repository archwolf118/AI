...
(2, 0): 0, (2, 1): 0, (2, 2): 1, (2, 3): 1, (2, 4): 1, (2, 5): 0, (2, 6): 0, 
(3, 0): 0, (3, 1): 0, (3, 2): 1, (3, 3): 2, (3, 4): 1, (3, 5): 0, (3, 6): 0, 
(4, 0): 0, (4, 1): 0, (4, 2): 1, (4, 3): 1, (4, 4): 1, (4, 5): 0, (4, 6): 0, 
...
def custom_score(game, player):
    ...
    open_move = len(game.get_legal_moves(player))
    pos_score = place_value[game.get_player_location(player)]
    return float(open_move + pos_score)
...
def custom_score_2(game, player):
    ...
    return float(open_move + pos_score - opp_moves)
    # raise NotImplementedError
...
def custom_score_3(game, player):
    ...
    pos_score = place_value[game.get_player_location(player)]
    opp_moves = len(game.get_legal_moves(game.get_opponent(player)))
    return float(open_move + pos_score - 2 * opp_moves)
